...
# Command note
noinst_LIBRARIES += src/libsinglebin_note.a
src_libsinglebin_note_a_SOURCES =   src/note.c
src_libsinglebin_note_a_DEPENDENCIES = $(src_note_DEPENDENCIES)
src_libsinglebin_note_a_CFLAGS = "-Dmain=single_binary_main_note (int, char **);  int single_binary_main_note"  -Dusage=_usage_note $(src_coreutils_CFLAGS)
# Command numfmt
